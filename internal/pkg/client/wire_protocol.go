...
func (c *Client) GetExt() map[string]string {
	return c.ext
}
...
func (c *Client) Hello(localName string) error {
	if err := utils.ValidateLine(localName); err != nil {
		return err
	}
	if c.didHello {
...
func (c *Client) Verify(addr string) error {
	if err := utils.ValidateLine(addr); err != nil {
		return err
	}
	if err := c.hello(); err != nil {
		return err
...
func (c *Client) Rcpt(to string) error {
	if err := utils.ValidateLine(to); err != nil {
		return err
	}
